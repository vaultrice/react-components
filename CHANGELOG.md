...
## [1.2.1](https://github.com/vaultrice/react-components/compare/v1.2.0...v1.2.1) - 2025-09-14

- **Dynamic Authentication**: Enhanced `auth` prop with optional `getIdentityToken()` function
