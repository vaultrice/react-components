import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as t}from"./iframe-h-Gz1dj-.js";import{C as Q}from"./Chat-C9hLqbo7.js";import{P as Z}from"./Presence-B7JugaS8.js";import"./theme-ELSemj-T.js";import"./preload-helper-D9Z9MdNV.js";import"./useNonLocalStorage-w7ePNe5P.js";const S=({id:a,user:p,title:n,subtitle:u,showPresence:r=!0,showHeader:c=!0,credentials:l,instanceOptions:g,deduplicateBy:m,predefinedUsers:T,showOfflineUsers:f,maxAvatars:M,renderPresenceAvatar:k,renderChatAvatar:s,renderMessage:y,placeholder:I,showTimestamps:W=!0,showUserAvatars:H=!0,autoScroll:L=!0,messageFilter:O,disabled:z=!1,persistMessages:B=!1,messageHistoryLimit:V=100,onMessage:J,onSendReady:$,onPresenceMessage:q,onPresenceSendReady:D})=>{const[R,E]=t.useState(0),[h,N]=t.useState(null),F=t.useCallback(i=>{N(i),D&&D(i)},[D]),_=t.useCallback(i=>{i.type==="presence"?(i.action==="join"||i.action==="update")&&h&&h({type:"get-presence"}):i.type==="presence-state"&&Array.isArray(i.connections)&&E(i.connections.length),q&&q(i)},[q,h]);t.useEffect(()=>{h&&h({type:"get-presence"})},[h]);const G=n||"Team Chat",K=u||(R>0?`${R} online`:"Join the conversation");return e.jsxs("div",{className:"vaultrice-chatroom",children:[c&&(n||u||r)&&e.jsxs("div",{className:"vaultrice-chatroom-header",children:[e.jsxs("div",{className:"vaultrice-chatroom-header-text",children:[(n||r)&&e.jsx("h3",{className:"vaultrice-chatroom-title",children:G}),(u||!n&&R>=0)&&e.jsx("p",{className:"vaultrice-chatroom-subtitle",children:K})]}),r&&e.jsx("div",{className:"vaultrice-chatroom-presence",children:e.jsx(Z,{id:a,user:p,credentials:l,instanceOptions:g,deduplicateBy:m,predefinedUsers:T,showOfflineUsers:f,maxAvatars:M,renderAvatar:k,onMessage:_,onSendReady:F})})]}),e.jsx("div",{className:"vaultrice-chatroom-chat",children:e.jsx(Q,{id:a,user:p,credentials:l,instanceOptions:g,placeholder:I,showTimestamps:W,showUserAvatars:H,autoScroll:L,messageFilter:O,renderMessage:y,renderAvatar:s,disabled:z,persistMessages:B,messageHistoryLimit:V,onMessage:J,onSendReady:$})})]})};S.__docgenInfo={description:"",methods:[],displayName:"ChatRoom",props:{id:{required:!0,tsType:{name:"string"},description:"Unique identifier for the chat room (shared between chat and presence)."},user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  name: string
  avatarUrl?: string
  id?: string
  [key: string]: any
...
}`,...j.parameters?.docs?.source}}};const de=["Default","WithPredefinedUsers","WithPersistentMessages","PersistentWithCustomLimit","Minimal","CompactWithPresence","Interactive","PersistenceAcrossInstances"];export{w as CompactWithPresence,x as Default,U as Interactive,P as Minimal,j as PersistenceAcrossInstances,C as PersistentWithCustomLimit,b as WithPersistentMessages,v as WithPredefinedUsers,de as __namedExportsOrder,oe as default};
