import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe-DQf5qH27.js";import{C as V}from"./Chat-RE88dAu9.js";import{P as J}from"./Presence-qAF7cA7p.js";import"./theme-ELSemj-T.js";import"./preload-helper-D9Z9MdNV.js";import"./useNonLocalStorage-DZ4AV3hH.js";const U=({id:a,user:l,title:i,subtitle:p,showPresence:r=!0,showHeader:o=!0,credentials:d,instanceOptions:h,deduplicateBy:c,predefinedUsers:j,showOfflineUsers:u,maxAvatars:S,renderPresenceAvatar:T,renderChatAvatar:s,renderMessage:f,placeholder:M,showTimestamps:I=!0,showUserAvatars:D=!0,autoScroll:q=!0,messageFilter:R,disabled:W=!1,persistMessages:A=!1,messageHistoryLimit:H=100,onMessage:L,onSendReady:z})=>{const O=i||"Team Chat",B=p||"Join the conversation";return e.jsxs("div",{className:"vaultrice-chatroom",children:[o&&(i||p||r)&&e.jsxs("div",{className:"vaultrice-chatroom-header",children:[e.jsxs("div",{className:"vaultrice-chatroom-header-text",children:[(i||r)&&e.jsx("h3",{className:"vaultrice-chatroom-title",children:O}),p&&e.jsx("p",{className:"vaultrice-chatroom-subtitle",children:B})]}),r&&e.jsx("div",{className:"vaultrice-chatroom-presence",children:e.jsx(J,{id:a,user:l,credentials:d,instanceOptions:h,deduplicateBy:c,predefinedUsers:j,showOfflineUsers:u,maxAvatars:S,renderAvatar:T})})]}),e.jsx("div",{className:"vaultrice-chatroom-chat",children:e.jsx(V,{id:a,user:l,credentials:d,instanceOptions:h,placeholder:M,showTimestamps:I,showUserAvatars:D,autoScroll:q,messageFilter:R,renderMessage:f,renderAvatar:s,disabled:W,persistMessages:A,messageHistoryLimit:H,onMessage:L,onSendReady:z})})]})};U.__docgenInfo={description:"",methods:[],displayName:"ChatRoom",props:{id:{required:!0,tsType:{name:"string"},description:"Unique identifier for the chat room (shared between chat and presence)."},user:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  name: string
  avatarUrl?: string
  id?: string
  [key: string]: any
...
}`,...P.parameters?.docs?.source}}};const Y=["Default","WithPredefinedUsers","WithPersistentMessages","PersistentWithCustomLimit","Minimal","CompactWithPresence","Interactive","PersistenceAcrossInstances"];export{C as CompactWithPresence,g as Default,w as Interactive,b as Minimal,P as PersistenceAcrossInstances,v as PersistentWithCustomLimit,x as WithPersistentMessages,y as WithPredefinedUsers,Y as __namedExportsOrder,X as default};
